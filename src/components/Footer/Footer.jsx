...
export default function Footer() {
    const date = new Date();
    const thisMonth = date.toLocaleString('en-us', { month: 'long' });
    ...
    return (
        <footer className="footer footer-center p-10 bg-neutral text-white ">
            <aside>
                ...
                {/* <NFRidoy light="true"></NFRidoy> */}
                <a className="font-black  font-sans  text-xl text-white">
                ...
                <p>Copyright © {thisMonth}, {thisYear} - All right reserved</p>
            </aside>
            <nav>
