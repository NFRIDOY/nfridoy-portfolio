        ...
        <div>
            ...
            {/* <Container>
                <section className="flex w-full">
                    <SwiperSlide className="w-1/2">
                        ...
                        <section id="frontEnd" className="h-fit  rounded-md p-4 grid grid-cols-2 gap-3">
                            <SwiperSlide>
                            <div>
                            </div>
                    ...
                    <SwiperSlide className="w-1/2">
                        <SwiperSlide className="">
                            ...
                            <section id="backEnd" className="h-fit rounded-md p-4 grid grid-cols-2 gap-3">
                                <SwiperSlide>
                                <div>
                                </div>
            ...
            <Container>
                <Paragraph1>
                    ...
                    >
                        {/* <SwiperSlide className="skilltype"> */}
                        <SwiperSlide>
                            <div>
